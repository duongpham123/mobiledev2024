 ...
 */
public class WeatherAndForecastFragmentTwo extends Fragment {
    ...
    public WeatherAndForecastFragmentTwo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_weather_and_forecast_two, container, false);

        ImageButton sb = view.findViewById(R.id.setting_button_two);
        ...
        ImageButton rb = view.findViewById(R.id.refresh_button_two);
